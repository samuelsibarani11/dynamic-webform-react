...
const DynamicForm = ({ schema, onSubmit }) => {
  ...
  //       const fileField = "id_photo_url"; // Sesuaikan dengan nama field file
  ...
  //             return; // Keluar jika upload gagal
  //           }

  //           // Ambil public URL untuk file yang di-upload
  ...
  //               urlError?.message
  //             );
  //             return; // Keluar jika public URL gagal di-generate
  //           }

  //           if (fileData.publicUrl) {
  //             // Update formData dengan file URL
  //             setFormData((prevData) => ({
  //               ...prevData,
  //               [fileField]: fileData.publicUrl,
  //             }));
  //           }
  //         } catch (uploadError) {
  //           console.error(
  ...
  //             uploadError.message
  //           );
  //           return; // Keluar jika terjadi kesalahan saat upload
  //         }
  //       }

  //       // Submit the form with the updated formData (including the file URL)
  //       await submitForm(
  //         formData,
  //         schema,
  //         signatureData,
